...
import static com.music.test.musicTest.common.SpotifyConstants.PLAYLIST_EXTERNAL_URL_KEY;
...
public class SpotifyObjectMapper {
    ...
    public static Playlist toPlaylist(PlaylistSimplified playlistSimplified) {
        ...
        final String externalUrl = externalUrls.getOrDefault(PLAYLIST_EXTERNAL_URL_KEY, "Not availble");
